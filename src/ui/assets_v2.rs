...
//!
//! This module is the Phase 1a replacement for `assets.rs`; the cutover
//! task (Task 34) renames it once the legacy UI is deleted.
...
/// Full list of embedded assets. Extended by Tasks 22-29 as HTML/JS files
/// are added.
pub const ASSETS: &[Asset] = &[
    ...
    Asset {
        ...
        body: include_bytes!("../../assets/setup-ui-v2/vendor/alpine/alpine.min.js"),
    },
    // Poppins font (Latin subset, 4 weights)
    Asset {
        path: "/vendor/poppins/poppins-400.woff2",
        mime: "font/woff2",
        body: include_bytes!("../../assets/setup-ui-v2/vendor/poppins/poppins-400.woff2"),
    },
    Asset {
        path: "/vendor/poppins/poppins-500.woff2",
        mime: "font/woff2",
        body: include_bytes!("../../assets/setup-ui-v2/vendor/poppins/poppins-500.woff2"),
    },
    Asset {
        path: "/vendor/poppins/poppins-600.woff2",
        mime: "font/woff2",
        body: include_bytes!("../../assets/setup-ui-v2/vendor/poppins/poppins-600.woff2"),
    },
    Asset {
        path: "/vendor/poppins/poppins-700.woff2",
        mime: "font/woff2",
        body: include_bytes!("../../assets/setup-ui-v2/vendor/poppins/poppins-700.woff2"),
    },
    // Stylesheets
    Asset {
        path: "/styles/tokens.css",
        mime: "text/css; charset=utf-8",
        body: include_bytes!("../../assets/setup-ui-v2/styles/tokens.css"),
    },
    Asset {
        path: "/styles/base.css",
        mime: "text/css; charset=utf-8",
        body: include_bytes!("../../assets/setup-ui-v2/styles/base.css"),
    },
    Asset {
        path: "/styles/layout.css",
        mime: "text/css; charset=utf-8",
        body: include_bytes!("../../assets/setup-ui-v2/styles/layout.css"),
    },
    Asset {
        path: "/styles/components.css",
        mime: "text/css; charset=utf-8",
        body: include_bytes!("../../assets/setup-ui-v2/styles/components.css"),
    },
    Asset {
        path: "/styles/animations.css",
        mime: "text/css; charset=utf-8",
        body: include_bytes!("../../assets/setup-ui-v2/styles/animations.css"),
    },
    // Icons
    Asset {
