//! Web-based setup UI server (legacy implementation).
//!
...
//!
//! This module is the pre-Phase-1a implementation, kept intact while the new
//! dashboard is built out in sibling modules. It will be removed in the cutover
//! task at the end of Phase 1a.
